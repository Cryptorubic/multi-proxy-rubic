...
FUNCTION="startBridgeTokensViaGenericCrossChainPermit2((bytes32,string,address,address,address,address,address,address,uint256,uint256,bool,bool),(address,address,uint256,bytes))"
...
SENDING_ASSET_ID=0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913
...
TARGET_ADDRESS=0xcaf2da315f5a5499299a312b8a86faafe4bad959
APPROVE_TO=0xcaf2da315f5a5499299a312b8a86faafe4bad959
EXTRA_NATIVE=0
