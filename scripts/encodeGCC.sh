...
TARGET_ADDRESS=0x663DC15D3C1aC63ff12E45Ab68FeA3F0a883C251
APPROVE_TO=0x663DC15D3C1aC63ff12E45Ab68FeA3F0a883C251
EXTRA_NATIVE=5000000000000000
...
echo "0x647eb57e"$(cast ae $FUNCTION $BRIDGE_DATA "($TARGET_ADDRESS,$APPROVE_TO,$EXTRA_NATIVE,$DATA)")
