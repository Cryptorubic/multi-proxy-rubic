...
contract NXTPFacet is IRubic, ReentrancyGuard, SwapperV2, Validatable {
    /// Storage ///
    ...
    function startBridgeTokensViaNXTP(IRubic.BridgeData memory _bridgeData, NXTPData calldata _nxtpData)
        external
        payable
        nonReentrant
    ...
    function _startBridge(IRubic.BridgeData memory _bridgeData, NXTPData memory _nxtpData) private {
