...
contract GenericCrossChainFacetV2 is
    IRubic,
    ReentrancyGuard,
    SwapperV2,
    Validatable
{
    ...
    function startBridgeTokensViaGenericCrossChainV2(
    ...
    /// @param _genericData data specific to GenericCrossChainFacet
    function swapAndStartBridgeTokensViaGenericCrossChainV2(
        IRubic.BridgeData memory _bridgeData,
